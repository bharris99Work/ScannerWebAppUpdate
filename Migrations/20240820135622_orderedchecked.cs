...
{
    /// <inheritdoc />
    public partial class orderedchecked : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckedIn = table.Column<int>(type: "INTEGER", nullable: false),
                    SignedOff = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReturnPartId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ReturnPartNumber = table.Column<string>(type: "TEXT", nullable: false),
                    JobPartId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReturnParts", x => x.ReturnPartId);
                });
